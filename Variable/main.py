...
from graf import (
    ...
    guardar_corriente_bobinas, 
    graficar_energia_termica, 
    graficar_presion_corriente, 
    graficar_campo_magnetico, 
    graficar_campo_magnetico_total, 
    graficar_separatrix,
    guardar_corriente_bobinas2
) #Esta proviene del archivo graph.py dónde están las 
#ritunas de graficación
...
guardar_perfiles(eq, profiles, RX, RZ, CIX, CIZ, CIX1, CIZ1, CIX2, CIZ2, CIX3, CIZ3, path_tablas, nombre1)
...
guardar_corriente_bobinas(eq, path_tablas, nombre1)
...
#guardar_corriente_bobinas2(eq, path_tablas, nombre1)